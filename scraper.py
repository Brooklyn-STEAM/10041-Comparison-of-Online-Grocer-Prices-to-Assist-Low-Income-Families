...
for search in stuff:
    try:
        ...
        foodbazaar = []
        foodbazaar.append("None")
        foodbazaar.append(0.00)
    ...
    try:
        ...
        cursor.execute("""
                    ...
                    ON DUPLICATE KEY UPDATE
                        ...
                        `product_price` = %s,
                        `company` = %s;
        """, (str(product_id), "None", 0, fb_name, str(product_id), "None", 0, fb_name))
    ...
    try:
        ...
        cursor.execute("""
                    ...
                    ON DUPLICATE KEY UPDATE
                        ...
                        `product_price` = %s,
                        `company` = %s;
        """, (str(product_id), "None", 0, walmart_name, str(product_id), "None", 0, walmart_name))
    ...
    try:
        ...
        cursor.execute("""
                    ...
                    ON DUPLICATE KEY UPDATE
                        ...
                        `product_price` = %s,
                        `company` = %s;
        """, (str(product_id), "None", 0, aldi_name, str(product_id), "None", 0, aldi_name))
